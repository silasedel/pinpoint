...
**Loop games.** A switch under Rounds, for a manager who is hosting. After a game ends the final screen counts down twenty seconds and the next game starts on its own with the same settings, even if you are the only one in it.
